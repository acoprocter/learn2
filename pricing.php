...
<html>
    ...
    <title>WriteMaps | Create Sitemaps Online</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
		
    <meta name="description" content="WriteMaps | Make, create, and build sitemaps | Plan websites | Gather content">
    <meta name="author" content="writemaps.com">

    <!-- Bootstrap CSS -->

	<link href="bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<link href="includes/font-awesome-4.0.3/css/font-awesome.min.css" rel="stylesheet"> 
...
<!-- HEADER --> 
  ...
  <nav class="navbar navbar-default navbar-inverse" id="top-nav" role="navigation">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="images/wmlogo.png" alt="Your Logo" /></a>
    </div>
...
<!-- FOOTER -->
	<footer>
		<div class="container" >
			<div class="row" id="footer-ul-content">
				...
				<div class="col-sm-3">
					<h6>ABOUT</h6>
					<ul class="unstyled">
						<li><a href="#">About WriteMaps</a></li>
						<li><a href="#">Blog</a></li>
					</ul>
			...
			<div class="col-sm-12" id="copyright">
					<h6>&copy; 2014 Writemaps. All Rights Reserved.</h6>
